...
Any formatting comes with a performance cost, though to denounce it as a trade-off would require complete automation (when you wouldn't ask about learning curves).
